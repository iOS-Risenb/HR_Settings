...
#====================================================================
s.source           = { :git => 'https://github.com/iOS-Risenb/HR_Settings.git', :tag => s.version.to_s }
...
#====================================================================
# 'h,m' 之间不能有空格
s.source_files = 'HR_Settings/Classes/**/*.{h,m}'


# 3.3:资源文件
#====================================================================
# 'HR_Settings' 为存储的 bundleName
#s.resource_bundles = {
#    'HR_Settings' => ['HR_Settings/**/*.{storyboard,xib,png,plist}']
#}
